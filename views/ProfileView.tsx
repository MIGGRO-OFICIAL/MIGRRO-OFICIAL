...
import { Lock, Edit, CreditCard, ChevronRight, Shield, CheckCircle2, BarChart3, LogOut } from 'lucide-react';
        ...
        <div className="p-4 space-y-3">
            ...
            {(user.role === 'helper' || user.role === 'admin') && (
                <button 
                    ...
                    className="w-full bg-white border border-gray-200 text-gray-700 py-3 px-4 rounded-xl font-medium shadow-sm hover:bg-gray-50 flex items-center justify-between group transition-all"
                >
                    <span className="flex items-center"><BarChart3 size={18} className="mr-3 text-gray-400 group-hover:text-brand-500" /> Dashboard do Prestador</span>
                    <ChevronRight size={18} className="text-gray-300" />
                </button>
            )}
