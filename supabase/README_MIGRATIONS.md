...
```bash
psql "postgresql://postgres:123Mudarmiggro@db.gjphsheavnkdtmsrxmtl.supabase.co:5432/postgres" -f supabase/migrations/001_initial_schema.sql
```
...
- ⚠️ A senha do banco está no arquivo `ligando_miggro.md`
